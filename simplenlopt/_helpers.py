def local_optimizers_info():
    ...
    'NEWUOA'.ljust(23) + ': Gradient free.'.ljust(18),
    'NEWUOA_BOUND'.ljust(23) + ': Gradient free.'.ljust(18) + 'Supports: Bounds.']
...
def global_optimizers_info():
    ...
    "",
    'MLSL'.ljust(6) + ': Gradient based depending on local minimizer. Warning: Always takes maxeval function evaluations.',
    'ISRES'.ljust(6) + ': Gradient free.'.ljust(18) + ' Supports: Inequality Constraints, Equality Constraints. '
    'Warning'.ljust(6) + ': Always takes maxeval function evaluations.',
    'ESCH'.ljust(6) + ': Gradient free.'.ljust(18) + 'Warning: Always takes maxeval function evaluations.',
    'STOGO'.ljust(6) + ': Gradient based.'.ljust(18) + 'Warning: Always takes maxeval function evaluations.']
